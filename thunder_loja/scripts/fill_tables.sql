...
VALUES  ('ThunderMeia', 25.00, 'Meias cano longo estampada azul e amarela', 'Vestuário', 22),
        ...
        ('Camiseta P', 30.00, 'Camiseta estampada azul e amarela', 'Vestuário', 4),
        ('Camiseta M', 30.00, 'Camiseta estampada azul e amarela', 'Vestuário', 10),
        ('Camiseta G', 30.00, 'Camiseta estampada azul e amarela', 'Vestuário', 7),
        ('Samba Canção P', 25.00, 'Samba Canção estampada azul e amarela', 'Vestuário', 2),
        ('Samba Canção M', 25.00, 'Samba Canção estampada azul e amarela', 'Vestuário', 9),
        ('Samba Canção G', 25.00, 'Samba Canção estampada azul e amarela', 'Vestuário', 8),
